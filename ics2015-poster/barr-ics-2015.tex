...
\column{0.5}
  \begin{subcolumns}
    ...
    \subcolumn{0.5}\block{Why Haskell?}{123}
  \end{subcolumns}
...
\block{How this often gets implemented}{
  ...
  \textbf{Observations:} (1) This style imposes far more structure on the problem than what is often intended and needed to solve the problem. (2) Lack of types introduces error possibilities.
}
